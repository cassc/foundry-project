...
contract GatekeeperThreeScript is Script {
    ...
    function run() external{
        ...
        require(player != address(this), "player is not current user");
        ...
        // naut.submitLevelInstance(payable(address));
        naut.call(abi.encodeWithSignature("submitLevelInstance(address)", payable(instance)));
