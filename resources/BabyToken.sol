...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor(
    ) payable ERC20("MILE", "ML") {
        uint256 totalSupply_ = 210_000_000*10**18;
        _marketingWalletAddress = 0x12776863D3AB794A8500Bd6eFc4B4f530AE8eAAA;
        _devAddress = 0x99999999CC24D3Bc8Fba26113CE47fE5480e9dfd;
        require(
        ...
        if(block.chainid == 56){
                ...
                rewardToken = 0x89614e3d77C00710C8D87aD5cdace32fEd6177Bd;
        ...
        uint256 minimumTokenBalanceForDividends_ = 200_000*10**18;
