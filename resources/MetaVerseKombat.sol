...
/******************************************************************************
Token Name : MetaVerse Kombat
Short Name/Ticker : MVK
Total Supply : 300000000
Decimal : 18
Platform : BEP20
Project Name : MetaVerse Kombat
Website Link :
********************************************************************************/
...
contract MetaVerseKombat is Context, IERC20, Ownable,Initializable {
    ...
    function Initialize(address _marketingwallet,address router) onlyOwner external initializer {
        ...
        _tTotal = 300000000 * 10**18;
        _name = "MetaVerseKombat";
        _symbol = "MVK";
        _decimals = 18;
